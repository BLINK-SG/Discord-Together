...
module.exports = {
    ...
    description: 'Play poker.io in Discord Voice Channel',
    usage: '',
    /** 
     * @param {Client} client 
    ...
    run: async (client, message, args) => {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            if (!invite.code) return message.channel.send(
                new MessageEmbed()
                    .setDescription("I was unable to start a poker.io  session.")
                    .setColor("#ff0000")
            )
            message.channel.send(`Click This Link To Start a poker Session\nhttps://discord.com/invite/${invite.code}`)
        })
    }
}